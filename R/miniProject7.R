...
# load data
data <- read.csv('C:/filename.csv') # data should be 150 obs. x 4 variables
...
data_long <- data %>% gather() # data_long should be 300 obs. x 4 variables
...
summary <- data_long %>% group_by() %>% summarize() # summary should be 30 obs. x 4 variables
